    ...
    return (
        <>
            <div className="author-bio margin-bottom-30px">
                <div className="d-flex align-items-center">
                    ...
                    <div className="author-inner-bio">
                        <h4 className="author__title fw-bold pb-0 mb-1">{usercontent.name} <Tooltips id="t-1" title="Verified Account">
            ...
            <div className="modal-wrapper">
                <button type="button" className="theme-btn border-0" data-bs-toggle="modal" data-target=".bs-example-modal-lg">
