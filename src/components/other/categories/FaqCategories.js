                ...
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        <Link to="#" className="d-block padding-top-30px padding-bottom-30px">
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">getting started</span>
                        </Link>
                    </div>
                </div>
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        ...
                        <g>
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">pricing plans</span>
                        </Link>
                    </div>
                </div>
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        ...
                        <g>
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">sales question</span>
                        </Link>
                    </div>
                </div>
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        ...
                        <g>
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">usage guides</span>
                        </Link>
                    </div>
                </div>
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        <Link to="#" className="d-block padding-top-30px padding-bottom-30px">
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">information</span>
                        </Link>
                    </div>
                </div>
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        <Link to="#" className="d-block padding-top-30px padding-bottom-30px">
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">Transactions</span>
                        </Link>
                    </div>
                </div>
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        ...
                        <g>
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">card</span>
                        </Link>
                    </div>
                </div>
                <div className="col-lg-3 column-td-6">
                    <div className="category-item faq-cat-item p-0">
                        ...
                        <g>
                            ...
                            <span className="d-block font-size-18 fw-semibold mt-3">account</span>
                        </Link>
                    </div>
                </div>
            </div>
