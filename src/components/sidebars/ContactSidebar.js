            ...
            <div className="billing-form-item">
                ...
                <div className="billing-content">
                    <div className="our-office-content">
                        <img src={contactinfo.img} alt="office" className="w-100 radius-round" />
                        ...
                        <ul className="info-list">
                            <li className="d-inline-block mb-2 me-2">
                ...
                <div className="billing-content">
                    <ul className="list-items">
                        <li className="d-flex align-items-center justify-content-between color-text-2">
                            <strong className="fw-medium">{contactinfo.opendays}</strong><strong className="fw-medium color-text-3">{contactinfo.opendaytime}</strong>
                        </li>
                        <li className="d-flex align-items-center justify-content-between color-text-2">
                            <strong className="fw-medium">{contactinfo.closeday}</strong><strong className="color-text">Closed</strong>
                        </li>
                    </ul>
                </div>
            </div>
