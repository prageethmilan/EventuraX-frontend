...
import { AiOutlineExclamationCircle, AiOutlinePlusCircle, AiOutlinePoweroff, AiOutlineUser, AiOutlineYoutube } from 'react-icons/ai';
import { BsBookmark, BsListCheck, BsPencil } from 'react-icons/bs';
                            ...
                            <div className="col-lg-12">
                                <div className="dashboard-nav d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div className="btn-box">
                                        ...
                                        <Link to="/" className="theme-btn ms-1"><span className="la"><AiOutlinePoweroff /></span> sign out</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-12">
                                                            ...
                                                            <div className="card-content-wrap">
                                                                ...
                                                                <div className="rating-row">
                                                                    <div className="edit-info-box">
                                                                        <button type="button" className="theme-btn button-success border-0 me-1">
                ...
                <div className="modal fade account-delete-modal" tabIndex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                    ...
                    <div className="modal-dialog modal-sm" role="document">
                        <div className="modal-content p-4">
                            ...
                            <div className="btn-box">
                                <button type="button" className="theme-btn border-0 button-success me-1" data-dismiss="modal">
                                    Cancel
                                </button>
