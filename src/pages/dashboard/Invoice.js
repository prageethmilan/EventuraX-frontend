                            ...
                            <div className="invoice-content">
                                ...
                                <div className="invoice-item">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6">
                                            <ul className="invoice-details text-end">
                                            ...
                                            <div className="invoice-table mt-3 table-responsive">
                                                <table className="w-100">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="pt-1 pe-0 text-end"><span>$16.00</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th className="pt-1 pb-0">Discount:</th>
                                                        <td className="pt-1 pe-0 text-end"><span>-2%</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th className="pt-1 pb-0">Total Amount:</th>
                                                        <td className="pt-1 pe-0 text-end"><span>$14.00</span>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="btn-box mt-4 text-center">
                                <button onClick={() => window.print()} className="theme-btn border-0">
                                    <span className="la"><AiOutlinePrinter /></span> print this invoice
                                </button>
                                <Link to="/" className="theme-btn ms-2">
