...
import { FaFacebookF, FaGooglePlusG, FaInstagram, FaLinkedinIn, FaPinterest, FaRegMoneyBillAlt, FaSnapchatGhost, FaTumblr, FaTwitter, FaVk, FaYoutube } from 'react-icons/fa';
...
import Tooltips from '../../components/other/tooltips/Tooltips';
const state = {
                            ...
                            <div className="col-lg-12 position-relative">
                                <div className="breadcrumb-content">
                                    ...
                                    <ul className="listing-info mt-3 mb-3">
                                        <li>
                                            <Tooltips id="to-4" title="Pricey">
                                                <div className="theme-btn average-symble" >
                                        ...
                                        <li>
                                            <div className="average-ratings">
                                                <span className="theme-btn button-success me-1">
                    ...
                    <div className="modal-dialog modal-lg" role="document">
                        <div className="modal-content">
                            <div className="modal-top">
                                <button type="button" className="btn-close close close-arrow" data-dismiss="modal" aria-label="Close">
